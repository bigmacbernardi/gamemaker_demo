...
if menuDisplaying{
	...
	draw_sprite_stretched(spr_menu_temp,0,x+40+submenuDisplaying?30+(30*(4-cols)):90,y-6 - (bigSubmenu * 12) - (rows>5?30:0),submenuDisplaying?100*cols:75*cols,120);
	drawX = x + 10 + submenuDisplaying?(30*(4-cols))+44:110;
	for (var c = 0; c<cols;c++){
		drawY = y - (rows * 12) + 46 - (rows>5?11:0);
