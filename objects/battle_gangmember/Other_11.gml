...
with inst{
	ds_list_add(lines,mytle+":  Gang ganga gangang agna");				//line 0
	ds_list_add(lines,mytle+":  Go thank a criminal you Petersonian prick");	//line 1
	...
	ds_list_add(lines,"The boss will be pleased!  I love America");		//line 6
