/// @description Ancyra outdoor spawner
// Remember to DESTROY when leaving.
scriptedFights = [
	[battle_gangmember,224,124],//0
	[battle_gangmember,234,76,battle_gangmember,276,100],
...
global.spawnController=spawn_controller2;
