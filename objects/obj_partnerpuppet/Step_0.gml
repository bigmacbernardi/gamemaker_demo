...
/*if (!paused){
	...
	var right_key = keyboard_check(0x44) or keyboard_check(vk_right);
	var run_key = keyboard_check(vk_shift);
	var slow_key = keyboard_check(vk_control);
	var check_butt = keyboard_check(vk_space) || keyboard_check(vk_enter);
